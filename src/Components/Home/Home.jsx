...
export const Home = () => {
  ...
  return (
    ...
    <CustomCursor />
     <div className="pt-10 ">
       <div className="container flex lg:justify-around md:justify-between flex-col items-center md:flex-row">
        ...
        <div className="lg:h-[400px] md:h-[300px] relative ">
          ...
          <div className="lg:w-[90px] lg:h-[90px] border-[#FFB647] border-[10px]  rounded-full opacity-50 absolute top-5 right-0 z-[1] "></div>
          <div className="absolute bottom-0 right-7 "><MegaButton /></div>
        </div>
       </div>
     </div>
    </>
