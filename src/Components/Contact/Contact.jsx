...
const Contact = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-50 to-gray-100 text-black p-8">
      {/* Contact Information */}
      <div className="mb-12">
        <h2 className="text-3xl font-semibold mb-8 text-center text-black">Contact Information</h2>
        <div data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1500" className="flex flex-col lg:flex-row justify-center gap-5">
          <div className="group relative p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 w-full max-w-sm mx-auto">
            ...
            <p className="text-lg text-center font-medium text-black group-hover:text-teal-700 duration-300 transition-all">nasrinbinteenizam@gmail.com</p>
          </div>
          <div className="group relative p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 w-full max-w-sm mx-auto">
            <div className="flex items-center justify-center mb-4">
              <HiOutlinePhone className="text-5xl text-teal-600 group-hover:text-teal-700 transition-all duration-300" />
            </div>
            <p className="text-lg text-center font-medium text-black group-hover:text-teal-700 transition-colors duration-300">+880 01706226996</p>
          </div>
        </div>
      </div>
     ...
     data-aos-duration="2000" className="mb-16">
      ...
      {/* Social Links */}
      <div className="mb-16">
        <h2 className="text-3xl font-semibold mb-8 text-center text-black">Follow Me</h2>
      ...
      {/* Google Map */}
      <div>
        <h2 className="text-3xl font-semibold mb-8 text-center text-black">Find Me Here</h2>
