...
<div className="min-h-screen flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-5xl space-y-8">
        ...
        <div className="flex justify-center gap-6">
          <Link data-aos="zoom-out" to="https://www.facebook.com/profile.php?id=61557964826146" target='_blank' className="group ">
          ...
          <Link data-aos="zoom-out" to="https://github.com/NasrinNizam" target='_blank' className="group">
            <div className="p-4 md:p-6 border-[1px] border-teal-600 rounded-full bg-white shadow-lg hover:shadow-2xl transition-transform duration-300 transform group-hover:scale-110">
              <FaGithub className="md:text-5xl text-3xl text-teal-600 group-hover:text-teal-700 transition-colors duration-300" />
            </div>
          </Link>
          <Link data-aos="zoom-out" to="https://www.linkedin.com/in/nasrin-sultana-5a59b9301?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target='_blank' className="group">
            <div className="p-4 md:p-6 border-[1px] border-teal-600 rounded-full bg-white shadow-lg hover:shadow-2xl transition-transform duration-300 transform group-hover:scale-110">
